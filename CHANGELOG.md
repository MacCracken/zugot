...
- **base/** (12): `bc` 7.0.3→7.1.0, `boost` 1.90.0→1.91.0, `dracut` 110→111, `expat` 2.7.5→2.8.1, `gyp` 0.22.0→0.22.2, `hyprwayland-scanner` 0.4.5→0.4.6, `iana-etc` 20260409→20260511, `intel-ucode` 20260227→20260512, `libnghttp2` 1.68.1→1.69.0, `llvm` 22.1.3→22.1.6, `meson` 1.11.0→1.11.1, `mimalloc` 3.3.0→3.3.2.
